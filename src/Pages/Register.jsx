...
export default function Register() {
  ...
  >
    ...
    <div className="mt-6 xs:mt-4">
      <button
        className="w-full border border-gray-300 dark:border-gray-700 bg-gray-100/70 dark:bg-[#1c2128] hover:bg-gray-200 dark:hover:bg-[#21262d] text-gray-700 dark:text-gray-200 rounded-xl py-2 xs:py-1 font-medium flex items-center justify-center gap-2 transition-all duration-300 text-sm xs:text-xs"
      >
        <img
